...
alias llm='cd ~/Projects/live/ledger-live-mobile'
alias lld='cd ~/Projects/live/ledger-live-desktop'
alias llc='cd ~/Projects/live/ledger-live-common'
alias sourcezsh='source ~/.zshrc'
alias dot='cd ~/dotfiles'
alias psgrep='ps aux | grep -v grep | grep -i '
alias showFiles='defaults write com.apple.finder AppleShowAllFiles YES; killall Finder /System/Library/CoreServices/Finder.app'
alias hideFiles='defaults write com.apple.finder AppleShowAllFiles NO; killall Finder /System/Library/CoreServices/Finder.app'
alias droid-ss='adb shell screencap -p /sdcard/screencap.png && adb pull /sdcard/screencap.png "android screencap $(date "+%Y-%m-%d %H:%M:%S").png"'
